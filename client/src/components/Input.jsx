...
const Input = ({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="input flex gap-3 px-4 bg-black dark:bg-white">
        ...
        <div className="input-post grow">
          <div className="flex flex-col">
            <TextareaAutosize
              ...
              id="status"
              minRows="2"
              className={`w-full bg-transparent dark:bg-white dark:text-black focus:outline-none text-xl ${
          ...
          >
            <div className="space-x-3">
              ...
              ></i>
              <span className="relative pointer-events-auto" ref={smileRef}>
                <i
