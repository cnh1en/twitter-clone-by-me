...
const ComposeMessage = ({ setShowCompose }) => {
  ...
  return (
    <div className="fixed w-full h-screen top-0 left-0 z-50 md:bg-transparent-config">
      <div className="w-full h-full bg-black px-3 md:md-modal-new-message dark:bg-white">
        <div className="pt-4 text-[20px] font-bold bg-transparent sticky top-0 bg-black z-20 space-y-3 dark:bg-white">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              >
                <i className="ri-close-line text-xl cursor-pointer text-white dark:text-black"></i>
              </span>
          ...
          <div className="search-people -mx-3 relative">
            <input
              ...
              className="peer bg-transparent w-full text-[15px] py-2 pl-16 border-b-[1px] border-color placeholder:text-[#575B5F] focus:outline-none dark:bg-white dark:border-gray-200 dark:text-black"
