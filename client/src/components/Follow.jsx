...
const Follow = ({ setShowFollow, tab, setTab }) => {
  ...
  return (
    <>
      <div className="width-page divide-y divide-[#2F3336] z-50 bg-black dark:bg-white dark:divide-gray-300">
        <div className="space-y-2">
          <div className="flex items-center justify-between sticky top-0 z-30 h-[53px] bg-transparent px-3 dark:bg-white dark:bg-opacity-40">
          ...
          <div className="tabs flex h-[54px]">
            <span
              className="followers w-1/2 flex-center hover:bg-opacity-10 hover:bg-[#d9d9d9] cursor-pointer relative text-white dark:text-black font-bold"
              onClick={() => setTab(true)}
            >
              Followers
              {tab && (
            ...
            <span
              className="following w-1/2 flex-center hover:bg-opacity-10 hover:bg-[#d9d9d9] cursor-pointer relative text-white dark:text-black font-bold"
          ...
          <div className="followers p-3 space-y-3">
            {profile?.info.followers?.map((follower) => (
              <div className="flex gap-2" key={follower._id}>
                <Avatar width="w-12" height="h-12" src={follower.avatar} />
                ...
                <div className="flex flex-col gap-1 grow justify-center">
                  ...
                  <div className="story font-[300]">{follower.story}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="following p-3 space-y-3">
            {profile?.info.following?.map((following) => (
              <div className="flex gap-2" key={following._id}>
                <Avatar width="w-12" height="h-12" src={following.avatar} />
                ...
                <div className="flex flex-col gap-1 grow justify-center">
                  ...
                  <div className="story font-[300]">{following.story}</div>
                </div>
              </div>
            ))}
          </div>
