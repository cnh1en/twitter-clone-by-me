...
const EditProfile = ({ setEditProfile }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen z-50 md:bg-transparent-config">
      <div className="absolute top-0 left-0 w-full z-30 md:md-tweet-post md:w-[600px] md:h-[650px] md:rounded-2xl bg-black h-screen overflow-auto scrollbar pb-8 dark:bg-white">
        <div className="edit-header px-3 sticky top-0 z-30 bg-transparent dark:bg-white">
          {loading && <LoadingLine />}
          <div className="flex justify-between items-center py-2 ">
            <div className="flex items-center gap-6">
              <span className="w-[40px] h-[40px] hover:bg-[#d9d9d9] hover:bg-opacity-10 rounded-full flex-center text-white dark:text-black dark:hover:border">
                <i
              ...
              <span className="text-[20px] font-[500] text-white dark:text-black">
                Edit profile
              </span>
            </div>
            <button
              className="px-4 py-1 font-[500] rounded-full bg-white text-black max-w-max hover:bg-[#D7DBDC] dark:border-gray-300 dark:border"
          ...
          <div className="form mt-[80px] w-full p-3 space-y-6">
            ...
            <div className="relative">
              <input
                ...
                id="name"
                name="name"
                className="w-full px-3 pt-7 pb-3 bg-black border-2 border-color rounded-md focus:outline-none focus:border-[#1D9BF0] peer dark:bg-white dark:border-gray-300 dark:text-black"
                value={info.name}
            ...
            <div className="relative">
              <textarea
                ...
                name="story"
                rows="4"
                className="w-full px-3 pt-7 pb-3 bg-black border-2 border-color rounded-md focus:outline-none focus:border-[#1D9BF0] peer scrollbar dark:bg-white dark:border-gray-300 dark:text-black"
                value={info.story}
                onChange={handleChangeInput}
                maxLength="160"
              ></textarea>
