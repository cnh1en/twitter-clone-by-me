...
const Login = () => {
  ...
  useEffect(() => {
    function start() {
      gapi.client.init({
        clientId:
          "117314368394-8bevrq0ck9c4cgs6k7e6ku4ichifmuno.apps.googleusercontent.com",
        scope: "email",
      });
    }
  ...
  return (
    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:w-[900px] md:py-[67px] py-5 shadow-login flex flex-col items-center md:flex-row w-[calc(100%_-_30px)] h-[calc(100vh-60px)] overflow-auto scrollbar-thin">
      ...
      <div className="md:mx-[80px] min-w-[295px]">
        <h2 className="text-[36px] font-[700] text-[#222222] mb-4">Sign up</h2>
        <p className="text-red-500 h-6 mb-5 text-md">{error}</p>
        ...
        <div className="social-network flex text-[13px] md:mt-20 items-center mt-8">
          ...
          <div className="flex ">
            <div className="transition ease-in-out delay-150 hover:-translate-y-2 hover:scale-125 duration-300">
              <GoogleLogin
                clientId="117314368394-8bevrq0ck9c4cgs6k7e6ku4ichifmuno.apps.googleusercontent.com"
                render={(renderProps) => (
                  <button
