...
const Profile = () => {
  ...
  return (
    <div
      className="width-page overflow-auto scrollbar bg-black z-30 dark:bg-white"
      ref={containerRef}
          ...
          <div className="flex items-center justify-between sticky top-0 z-30 h-[53px] bg-transparent px-3 py-4 text-[20px] dark:bg-white dark:bg-opacity-80">
            <div className="flex items-center gap-4">
              <span className="w-8 h-8 flex-center hover:hoverAnimation2">
                <i
                  className="ri-arrow-left-line text-xl cursor-pointer font-bold text-white dark:text-black"
                  onClick={() => navigate(-1)}
                ></i>
              </span>
