	...
	return !loading ? (
		<div className="width-page">
					...
					<div className="flex items-center gap-4">
						...
						<span className="font-bold flex items-center gap-2">
							...
							<div className="flex flex-col">
								<span className="text-[18px]">{user?.fullname}</span>
			...
			<div className="input-message py-2 flex-center space-x-2 px-3 border-t-[1px] border-color bg-black z-50">
				...
				<div className="grow border-[1px] border-color rounded-2xl p-2 flex items-start flex-col">
					{image && (
					...
					<TextareaAutoSize
						minRows="1"
						type="text"
						className="w-full py-1 pl-2 focus:outline-none text-[14px] placeholder:font-[300] bg-transparent"
				...
				<div
					className="button w-10 h-10 flex-center hover:hoverAnimation2 cursor-pointer"
